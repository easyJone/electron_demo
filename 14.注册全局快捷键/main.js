...
app.whenReady().then(() => {
  ...
  // 注册全局快捷键
  globalShortcut.register('option+e', () => {
    mainWindow.loadURL('https://www.baidu.com')
  })
  const isRegister = globalShortcut.isRegistered('option+e') ? 'success' : 'fail'
  ...
  mainWindow.loadFile('./home.html') // 载入本地文件
...
app.on('will-quit', () => {
  console.log('快捷键取消注册')
  globalShortcut.unregister('option+e') // 取消注册某个
  globalShortcut.unregister() // 取消注册全部快捷键
